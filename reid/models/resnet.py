...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, num_features=2048, 
        ...
        unset_module.append(self.embed_x3)
        self.bn_x3 = nn.BatchNorm2d(1792)
        unset_module.append(self.bn_x3)
        self.prelu_x3 = nn.PReLU()
        self.classifier_x3 = nn.Linear(1792, self.num_classes)
        unset_module.append(self.classifier_x3)
